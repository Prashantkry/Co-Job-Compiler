...
// modifying default AppBar with own CSS
      ...
      <Container position="static">
        <Toolbar className=" flex justify-between">
          <div className=" flex justify-center items-center">
            <img src={logo} alt="x" width={40} />
            <h2 className=" p-2 text-2xl">Co-Job Compiler</h2>
          </div>
          <h3 className=" shadow text-center text-white rounded-sm p-1 font-bold border-2 border-t-red-600 border-lime-600 border-r-indigo-700 border-x-amber-600 cursor-pointer">
            Start Coding
          </h3>
        </Toolbar>
      </Container>
